...
grid_size = 10
cell_size = 55  # un poco más grande
margin = 80
top_offset = 150
...
while True:
    ...
    # Mostrar texto en la cámara con el color detectado
    ...
    cv2.putText(frame, f"Tiempo restante: {remaining_time}s", (width - 270, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255,255,255), 2)
